function initialize() {
    ...
    // Multiple Markers
    var markers = [
        ['Parami Education, Tarmwe', 16.8123179,96.1687177],
        ['Parami Education, Myaynigone', 16.805298, 96.138038],
        ['Parami Education, Parami Rd', 16.857530, 96.123183]
    ];
                        
    // Info Window Content
    var infoWindowContent = [
        ['<div class="info_content">' +
        '<p>Parami Education, Tarmwe</p>'],
        ['<div class="info_content">' +
        '<p>Parami Education, Myaynigone</p>'],
        ['<div class="info_content">' +
        '<p>Parami Education, Parami Rd</p>']
    ];
